...
class ClanDetailsEmbed(ClanDraftEmbed):
    ...
    def __init__(
        ...
        *,
        ...
        lifetime_stats += f"__Record__: {wins} : {losses}"
        ...
        this_month_stats += f"__Record__: {month_wins} : {month_losses}"
    ...
    def __init__(
        ...
        *,
        ...
        if clan_config is not None:
            ...
            clan_lifetime_stats += f"__Record__: {wins} : {losses}"
        ...
        combined_lifetime_stats += f"__Record__: {combined_wins} : {combined_losses}"
